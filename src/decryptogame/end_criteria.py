...
class EndCondition(abc.ABC):
    ...
    @abc.abstractmethod
    def winner(game_data: GameData) -> Optional[int]:
        pass

    @abc.abstractmethod
    def loser(game_data: GameData) -> Optional[int]:
        pass
...
class MiscommunicationEndCondition(EndCondition):
    ...
    def winner(self, game_data: GameData) -> Optional[int]:
        return None
    
    def loser(self, game_data: GameData) -> Optional[int]:
...
def interception_miscommunication_diff_tiebreaker(game_data: GameData) -> Optional[int]:
